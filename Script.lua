...
local allowedUserIds1 = { 973799 }
local allowed1 = false
for _, id in ipairs(allowedUserIds1) do
...
local Fluent = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/Arshenxr/G7dK3mN9vQ2xR6zY1bT8pF0sH4wL5cEJ/refs/heads/main/main.lua"))()
local SaveManager = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/Arshenxr/G7dK3mN9vQ2xR6zY1bT8pF0sH4wL5cEJ/refs/heads/main/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/Arshenxr/G7dK3mN9vQ2xR6zY1bT8pF0sH4wL5cEJ/refs/heads/main/InterfaceManager.lua"))()

repeat task.wait() until game:IsLoaded()
local allowedUserIds2 = { 973799 }
local allowed2 = false
for _, id in ipairs(allowedUserIds2) do
    if LocalPlayer.UserId == id then
        allowed2 = true
        break
    end
...
repeat task.wait() until game:IsLoaded()
local allowedUserIds3 = { 973799 }
local allowed3 = false
for _, id in ipairs(allowedUserIds3) do
    if LocalPlayer.UserId == id then
        allowed3 = true
        break
    end
end
if not allowed3 then
    LocalPlayer:Kick()
    return
end
...
createServerButton("Hop Server", function()
    Window:Dialog({
        Title = "Hop Server",
        Content = "Are you sure you want to Hop Server?",
        Buttons = {
            {
                Title = "Confirm",
                Callback = function()
...
repeat task.wait() until game:IsLoaded()
local allowedUserIds4 = { 973799 }
local allowed4 = false
for _, id in ipairs(allowedUserIds4) do
    if LocalPlayer.UserId == id then
        allowed4 = true
        break
    end
end
if not allowed4 then
    LocalPlayer:Kick()
    return
end
...
createServerButton("Hop To SmallServer", function()
    Window:Dialog({
        Title = "Hop To SmallServer",
        Content = "Are you sure you want to Hop To SmallServer?",
        Buttons = {
            {
                Title = "Confirm",
                Callback = function()
...
repeat task.wait() until game:IsLoaded()
local allowedUserIds5 = { 973799 }
local allowed5 = false
for _, id in ipairs(allowedUserIds5) do
    if LocalPlayer.UserId == id then
        allowed5 = true
        break
    end
end
if not allowed5 then
    LocalPlayer:Kick()
    return
end
...
repeat task.wait() until game:IsLoaded()
local allowedUserIds6 = { 973799 }
local allowed6 = false
for _, id in ipairs(allowedUserIds6) do
    if LocalPlayer.UserId == id then
        allowed6 = true
        break
    end
end
if not allowed6 then
    LocalPlayer:Kick()
    return
end
